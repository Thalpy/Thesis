...
0.6 mM demonstrates the difficulty present in fitting curves with short contact regions. Occasionally, a retrace will have a higher attractive force. In general however, 0.6 mM has very little to no attractive forces between the interacting elements.
...
A similar work by Kappl and Butt \cite{buttkappl} focuses on measuring adhesion forces between colloidal particles using AFM, providing a detailed analysis of how surface roughness, humidity, and applied load influence these forces.

In our work, similar methodologies were employed to investigate forces between silica surfaces in various ionic strengths, yet the focus extends beyond adhesion to explore the relationship between these microscale forces and the macroscopic rheological behavior of dense colloidal suspensions. Kappl and Butt observed that surface roughness plays a crucial role in deviating adhesion forces from theoretical predictions. This observation aligns with our findings where surface roughness significantly affects the measured forces, contributing to variations in the rheological properties of the suspensions.

Furthermore, while Kappl and Butt’s work primarily addresses the methodological aspects and implications for colloidal stability via adhesion forces, our results indicate that the observed forces, influenced by surface roughness and ionic strength, have a direct impact on the rheological properties, particularly in how these properties deviate from expected behavior in dense suspensions. \cite{buttkappl} 
